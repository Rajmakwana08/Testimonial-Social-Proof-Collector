...
urlpatterns = [
    ...
    path("accounts/verify/", views.verify_email, name="verify_email"),
    ...
    path("dashboard/testimonials/<int:pk>/<str:action>/", views.testimonial_action, name="testimonial_action"),
